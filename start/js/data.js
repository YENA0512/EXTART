const qnaList = [
  {
    ...
    a: [
      { answer: '가볍게 - 숨이 싶어지지만 편히 대화할 수 있는 정도', type: ['cow', 'tiger', 'dragon', 'chick'] },
      { answer: '강하게 - 대화하기에 숨쉬기 다소 힘든 정도', type: ['mouse', 'rabbit', 'horse', 'snake', 'dog', 'monkey'] },
      { answer: '아주 강하게 - 숨이 많이 차고 숨쉬기 힘든 정도', type: ['sheep', 'pig' ] },
    ]
  },
  {
    q: '2. 혼자서 하는 운동을 좋아하나요 다같이 하는 운동을 좋아하나요? ',
    a: [
      { answer: '혼자 운동하는 것을 좋아해요', type: ['mouse', 'rabbit', 'tiger', 'monkey'] },
      { answer: '여럿이 모여서 하는 함께 운동을 좋아해요', type: ['cow', 'horse', 'snake', 'dog'] },
      { answer: '팀을 결성해서 승부를 가리는 운동을 좋아해요', type: ['sheep', 'dragon', 'chick', 'pig'] },
    ]
  },
  {
    q: '3. 몸에서 통증을 느끼는 부위가 있나요?',
    a: [
      { answer: '일상생활에 지장이 갈 정도로 아픈 곳이 있어요', type: ['cow', 'tiger', 'dragon' ] },
      { answer: '조금 통증을 느끼지만 지장은 없어요', type: ['sheep', 'dog', 'monkey', 'chick', 'pig' ] },
      { answer: '부상 경험이 없고 불편한 부위가 없어요', type: ['mouse', 'rabbit', 'horse', 'snake' ] }
    ]
  }
]
